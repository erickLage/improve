                    ...
                    RaisedButton(
                      ...
                      onPressed: () async {
                        await Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Jogo1(widget.audio)));
                      },
                      child: Container(
...
class _Jogo1State extends State<Jogo1> {
  ...
  List<Map> prompts = [
    ...
    {'prompt': 'Busque uma xícara de café', 'arrastavel': 'xicara', 'itemAlvo': 'cafeteira'},
          ...
          child: Stack(
            children: [
              Column(
                children: [
                  SizedBox(height: 100),
                  Text(prompts[round]['prompt'], style: TextStyle(fontSize: 16, color: Colors.black)),
                  Container(
              ...
              Positioned(
                top: 25,
                right: 25,
                child: Text('${round+1}/4', style: TextStyle(fontSize: 16,color: Colors.black),),        
              ),
              Positioned(
                top: 10,
                left: 10,
